    ...
    <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`} >
        ...
        <div className='flex flex-row items-center justify-between w-full'>
          <h1 className='flex-1 font-poppins font-semibold ss:text-[72px] text-[45px] ss:leading-[100px] leading-[75px]'>
        ...
        <h1 className='font-poppins font-semibold ss:text-[68px] text-[45px] ss:leading-[100px] leading-[75px] w-full'>
            Payment Method.
        </h1>
